...
class HomeworksControllerTest < ActionController::TestCase
  ...
  test "should create homework" do
    assert_difference('Homework.count') do
      post :create, homework: { active: @homework.active, deadline: @homework.deadline, description: @homework.description, name: @homework.name, path: @homework.path, user_id: @homework.user_id }
    end
  ...
  test "should update homework" do
    put :update, id: @homework, homework: { active: @homework.active, deadline: @homework.deadline, description: @homework.description, name: @homework.name, path: @homework.path, user_id: @homework.user_id }
    assert_redirected_to homework_path(assigns(:homework))
  end
