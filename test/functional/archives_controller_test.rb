...
class ArchivesControllerTest < ActionController::TestCase
  ...
  test "should create archive" do
    assert_difference('Archive.count') do
      post :create, archive: { homework_user_id: @archive.homework_user_id, ip: @archive.ip, name: @archive.name, version: @archive.version }
    end
  ...
  test "should update archive" do
    put :update, id: @archive, archive: { homework_user_id: @archive.homework_user_id, ip: @archive.ip, name: @archive.name, version: @archive.version }
    assert_redirected_to archive_path(assigns(:archive))
  end
